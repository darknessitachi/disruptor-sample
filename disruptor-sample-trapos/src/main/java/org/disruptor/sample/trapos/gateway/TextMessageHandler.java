...
import org.disruptor.sample.trapos.ShutdownListener;
...
public class TextMessageHandler extends SimpleChannelUpstreamHandler {
    ...
    private static final Logger logger = LoggerFactory.getLogger(TextMessageHandler.class.getName());
